...
```bash
dotnet add package WinNotch.PluginSdk --version 0.6.1 --source github-winnotch
```
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="WinNotch.PluginSdk" Version="0.6.1" />
  </ItemGroup>
</Project>
```
...
public sealed class HelloWorldPlugin : PluginBase, IUIPlugin
{
    ...
    public override string MinimumWinNotchVersion => "0.6.1";
