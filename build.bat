@echo off
echo ========================================
echo  WinNotch v0.1.0 - Build Release
echo ========================================
echo.
...
if defined ISCC (
    ...
    echo  Output: publish\installer\WinNotch-0.1.0-Setup.exe
    echo ========================================
    for %%A in ("publish\installer\WinNotch-0.1.0-Setup.exe") do echo  Size: %%~zA bytes
) else (
